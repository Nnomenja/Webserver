...
HttpVersionParser::HttpVersionParser(Request *target, UnitConf_t endpoint):ARequestParserState(VERSION, target, endpoint), _protocol_name("HTTP/"), protocol_readed(false), _j(0){
